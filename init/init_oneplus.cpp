 ...
 * than once should be set in a typical init script (e.g. init.oneplus.hw.rc)
...
void vendor_load_properties() {
  ...
  OverrideProperty("ro.oneplus.project", "OP8");
      switch (rf_version){
          /* China */
        case 11:
  ...
  OverrideProperty("ro.oneplus.project", "OP8P");
      switch (rf_version){
          /* China */
        case 11:
